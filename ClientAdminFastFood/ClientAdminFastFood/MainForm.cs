...
namespace Hotel_SoftWare2
{
    public partial class MainForm : Form
    {
        ...
        {
            textBoxTitle.Text = "SẢN PHẨM";
            openChildForm(new SanPhamForm());
            HideMenu();
        }
        private void btnAccount_Click(object sender, EventArgs e)
        {
            textBoxTitle.Text = "ACCOUNT";
        ...
        {
            textBoxTitle.Text = "DANH MỤC SẢN PHẨM";
            openChildForm(new DanhMucSanPhamForm());
            HideMenu();
        }
        ...
        {
            textBoxTitle.Text = "CỬA HÀNG";
            openChildForm(new DonHangForm());
            HideMenu();
        }

        private void btnLoaiDV_Click(object sender, EventArgs e)
        {
            textBoxTitle.Text = "NHÀ CUNG CẤP";
